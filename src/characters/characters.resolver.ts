...
export class CharactersResolver {
  ...
  actors(
    ...
    return this.actorsService.findByCharacterId(character.character_id, { first, last, before, after });
  }
  ...
  organizations(
    ...
    return this.organizationsService.findByCharacterId(character.character_id, { first, last, before, after });
  }
  ...
  episodes(
    ...
    return this.episodesService.findByCharacterId(character.character_id, { first, last, before, after });
  }
}
